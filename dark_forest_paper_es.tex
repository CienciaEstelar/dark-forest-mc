...
% backref en español: cada entrada de la bibliografía indica en qué
% página(s) se citó, con el número de página clickeable hacia el texto.
\backrefspanish
...
% Suprime la cabecera "Mon. Not. R. Astron. Soc. ... / Printed <fecha> /
% (MN LaTeX style file v2.2)" de la primera página — cosmética de journal,
% no aplica a un preprint fuera del flujo editorial de MNRAS.
% Suprime también el pie "(c) 2026 RAS, MNRAS 000, 000-000" de las
% páginas de contenido (\ps@headings, la cabecera de página con el
% número sigue intacta, solo se vacía el pie de copyright).
\makeatletter
\gdef\@journal{}
\def\@oddfoot{}
\def\@evenfoot{}
