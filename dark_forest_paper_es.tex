...
\title[Bosque Oscuro Monte Carlo]{
  Del Silencio a la Concentración:\\
  Transición de Régimen en la Hipótesis del Bosque Oscuro\\
  Revelada por Simulaciones de Control\\
  con Dinámica de Destrucción Desactivada
}
...
$\Delta r$ en $< 0{,}01$, confirmando que la memoria histórica
